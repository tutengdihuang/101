...
import (
	...
	"github.com/cncamp/101/Allen/k8slearn/operator/k8s-test-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "de71ec97.cncamp.io",
	...
	if err := (&controller.K8sTestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "K8sTest")
		os.Exit(1)
	}
