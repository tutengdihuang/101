...
> 🎯 **一句话精华**：PrometheusRule = PromQL 表达式 + 持续时间 + 告警信息——就像给监控系统装上"嘴巴"，让它能主动告诉你问题！
...
> 📝 **下一篇**：[Pod 监控机制](08-pod-monitoring.md) - 深入理解 Pod 监控原理
